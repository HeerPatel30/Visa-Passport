...
import { 
  ...
  Plane, ShieldCheck, Fingerprint, FileText, Globe, User, ArrowRight
} from "lucide-react";
...
const ActionCard = ({ title, desc, icon, color, onClick }) => (
  <Card sx={{ 
    ...
    <CardActionArea onClick={onClick} sx={{ p: 4, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
      <Box sx={{ 
        width: 60, height: 60, borderRadius: '18px', bgcolor: `${color}10`, color: color, 
      ...
      <Button 
        ...
        sx={{ 
          ...
          pointerEvents: 'none' // Click handled by CardActionArea
        }}
      >
        Apply
      </Button>
...
const PassportSearch = () => {
  ...
  return (
    <Box sx={{
      minHeight: "100vh", position: "relative", pb: 10,
      background: `radial-gradient(circle at 10% 20%, rgba(180,210,255,.45) 0%, transparent 40%), radial-gradient(circle at 90% 80%, rgba(120,180,255,.35) 0%, transparent 40%), linear-gradient(135deg, #E5F0FF 0%, #F7FBFF 60%, #FFFFFF 100%)`
    }}>
      ...
      <Container maxWidth="lg" sx={{ pt: 10 }}>
        ...
        <Stack spacing={2} alignItems="center" sx={{ mb: 8 }}>
          <Chip 
            ...
            sx={{ 
              bgcolor: 'rgba(255,255,255,0.8)', color: '#4338ca', fontWeight: 800, 
              border: '1px solid rgba(79, 70, 229, 0.2)', backdropFilter: 'blur(10px)'
            }} 
          />
        ...
        <Box sx={{ 
          ...
          <ActionCard 
            title="Passport Enrollment" 
            desc="Start your journey by registering for a new passport or renewing your existing credentials securely." 
          ...
          <ActionCard 
            ...
            desc="Easily apply for international travel permits, work visas, or residency status online." 
            icon={<Plane size={28} />} 
            color="#0ea5e9" 
        ...
        {/* --- SEARCH BOX --- */}
        <Box sx={{ 
          bgcolor: 'rgba(255, 255, 255, 0.5)', backdropFilter: 'blur(24px) saturate(180%)',
          p: { xs: 3, md: 6 }, borderRadius: 10, border: '1px solid rgba(255, 255, 255, 0.3)',
          maxWidth: 900, mx: 'auto', boxShadow: '0 40px 80px rgba(0,0,0,0.07)'
        }}>
          <Tabs 
            value={searchMode} 
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} justifyContent="center">
            <TextField
              ...
              sx={{ 
                maxWidth: 500, 
                '& .MuiOutlinedInput-root': { borderRadius: 5, bgcolor: 'white', '& fieldset': { borderColor: 'rgba(0,0,0,0.05)' } } 
              }}
              InputProps={{ 
            ...
            <Button 
              ...
              sx={{ 
                borderRadius: 5, px: 6, py: 1.5, fontWeight: 800, bgcolor: '#4f46e5', textTransform: 'none', 
                boxShadow: '0 10px 25px rgba(79, 70, 229, 0.3)', '&:hover': { bgcolor: '#4338ca' }
              }}
            >
              ...
              <Stack spacing={4}>
                <Box sx={{ p: 2.5, bgcolor: '#f8fafc', borderRadius: 5, display: 'flex', alignItems: 'center', gap: 2.5, border: '1px solid #e2e8f0' }}>
                  <Avatar 
                    ...
                    sx={{ width: 64, height: 64, borderRadius: 3, bgcolor: '#4f46e5' }}
                  >
